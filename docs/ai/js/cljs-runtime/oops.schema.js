...
var G__20115 = cljs.core.first(element_str);
switch (G__20115) {
case "?":
arr.push((1));
...
var G__20260 = cljs.core.next(items);
items = G__20260;
continue;
} else {
return null;
...
var G__20268 = cljs.core.next(items);
items = G__20268;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__20186 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__20186) : is_valid_QMARK_.call(null,G__20186));
})())){
var G__20287 = cljs.core.next(cljs.core.next(items));
items = G__20287;
continue;
} else {
return true;
...
switch (G__20200) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__20188_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20188_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__20193_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__20193_SHARP_,(1));
})))){
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20200))));
